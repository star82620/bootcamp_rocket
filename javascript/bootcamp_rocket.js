...
//好像也不需要用這個
// const isRocket = document.querySelector("#about_rocket") || "";
// const isSpace = document.querySelector("#aboutUs") || "";
// const banner = [...document.querySelectorAll(".enter_card")];
...
//         banner[1].classList.remove("active");
//     } else {
//         // space page
...
function changeCoach() {
    ...
    cardContainer.addEventListener("click", (e) => {
        ...
        if(elementClass.contains("coach_img") || elementClass.contains("coach_name")) {
